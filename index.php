...
// --- AMBIL DATA STATISTIK DARI 4 TABEL UTAMA ---
$stats = [];
$stats['Produk'] = 0;
$stats['Pelanggan'] = 0;
$stats['Pesanan'] = 0;
...
$stat_queries = [
    'Produk' => "SELECT COUNT(id) as total FROM produk",
    'Pelanggan' => "SELECT COUNT(id) as total FROM pelanggan",
    'Pesanan' => "SELECT COUNT(id) as total FROM pesanan",
    'Pegawai' => "SELECT COUNT(id) as total FROM pegawai",
];
...
<head>
    ...
    <style>
        /* CSS KHUSUS DASHBOARD JAM */
        .digital-clock {
            font-size: 5rem; /* Ukuran jam diperkecil */
            font-weight: 700;
            letter-spacing: 5px;
            text-align: center;
            color: #17a2b8;
        ...
        /* Style Info Boxes (Salinan dari data_tabel.php agar tampilannya sama) */
        .small-box {
        ...
        .small-box h3 { font-size: 2.2rem; font-weight: 700; margin: 0 0 10px 0; padding: 0; white-space: nowrap; color: #fff; }
        .small-box p { font-size: 1rem; color: #fff; margin: 0; }
        .small-box .small-box-footer {
            background-color: rgba(0,0,0,.1); color: #fff; display: block; padding: 3px 0;
            position: relative; text-align: center; text-decoration: none; z-index: 10;
            border-bottom-left-radius: 0.25rem; border-bottom-right-radius: 0.25rem;
        }
        .small-box .small-box-footer:hover { background-color: rgba(0,0,0,.2); }
                    ...
                    <div class="col-lg-3 col-6">
                        <div class="small-box bg-success">
                            ...
                            <a href="data_tabel.php?table=pelanggan" class="small-box-footer">
                                Kelola Pelanggan <i class="fas fa-arrow-circle-right"></i>
                            </a>
                        </div>
                    </div>
